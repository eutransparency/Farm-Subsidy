...
urlpatterns = patterns('data.views',
  ...
  url(r'^(?P<country>%s)/location/(?P<name>[^/]+)/(?P<year>\d+)' % countries, 'location', name='location_view' ),
  url(r'^(?P<country>%s)/location/(?P<name>[^/]+)' % countries, 'location', name='location_view' ),
